...
$id = $_GET['id'];
$stmt = $admin -> ret("SELECT * FROM `category` WHERE `cid` = '".$id."'");
...
<div class="panel">
								...
								<div class="panel-body">
									...
									<input type="text" class="form-control" placeholder="Enter the Category Name..." value="<?php echo $row['cname']; ?>" name="a" required="">
									<br>
